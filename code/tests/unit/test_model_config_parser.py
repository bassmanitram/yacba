...
class TestModelConfigParserIntegration:
    ...
    def test_load_and_override_workflow(self, tmp_path):
        ...
        result = parse_model_config(
            ...
            overrides=["temperature: 0.7", "response_format.type: json"],
        )
    ...
    def test_overrides_only_workflow(self):
        ...
        result = parse_model_config(
            config_file=None, overrides=["temperature: 0.9", "max_tokens: 500"]
        )
    ...
    def test_array_indexing(self):
        ...
        ModelConfigParser.apply_property_override(config, "items[0].value", 10)
