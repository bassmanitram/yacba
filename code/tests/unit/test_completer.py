...
class TestYacbaCompleter:
    ...
    def test_is_file_completion_context_false(self):
        ...
        assert not completer._is_file_completion_context('filed("test')  # Wrong spelling
    ...
    def test_get_completions_file_context(self, mock_path_completer_class, mock_complete_event):
