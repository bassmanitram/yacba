...
examples:
  ...
  yacba link --list                    # Show available locations
    ...
    parser.add_argument(
        "path", nargs="?", help="Target directory (default: first writable in PATH)"
    )
    parser.add_argument("--name", default="yacba", help="Symlink name (default: yacba)")
    parser.add_argument(
        "--force",
        action="store_true",
    ...
    parser.add_argument(
        "--list", action="store_true", help="List available PATH locations"
    )
