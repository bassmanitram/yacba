...
class YacbaToStrandsConfigConverter:
    ...
    def _convert_tool_configs(self) -> List[Path]:
        ...
        logger.debug(
            "tool_config_paths_converted",
            count=len(self.yacba_config.tool_config_paths),
        )
        return result
    ...
    def _convert_file_uploads(self) -> List[Tuple[Path, Optional[str]]]:
        ...
        logger.debug(
            "file_uploads_converted", count=len(self.yacba_config.files_to_upload)
        )
        return result
    ...
    def _convert_conversation_manager_type(self) -> ConversationManagerType:
        ...
        if yacba_type == "null":
            ...
            logger.warning(
                "unknown_conversation_manager_type",
                type=yacba_type,
